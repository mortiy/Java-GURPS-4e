...
public class OdiousPersonalHabits extends LevelTrait implements Disadvantage {
    Modifier modifier;
    public OdiousPersonalHabits(Character character) {
        super(character, "Odious Personal Habits", -5, 3);
        modifier = character.addModifier(Rolls.ReactionRoll, new SummandModifier(0));
    }
