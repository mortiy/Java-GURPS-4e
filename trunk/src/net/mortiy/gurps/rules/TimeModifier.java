...
public class TimeModifier extends Modifier {
    ...
    public TimeModifier(Character character, Modifier.IModifiable modifiedEntity, float modifierValue, float timeInSeconds) {
        this(character, modifiedEntity, modifierValue, Math.round(timeInSeconds * 1000));
    }

    public TimeModifier(Character character, Modifier.IModifiable modifiedEntity, float modifierValue, long timeInMilliseconds) {
        super(character, modifiedEntity, new SummandModifier(modifierValue));
